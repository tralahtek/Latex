...
\companyname{TralahTek LLC} % Displayed in large letters at the top, can be replaced with an image or left blank for no company

\sendername{Tralah M Brian}
\senderjob{Computer Scientist}
\senderaddresslineone{Kilimani, Nairobi}
\senderaddresslinetwo{Konza City, Machakos}
\sendercontactlineone{musyoki.brian@tralahtek.com}
\sendercontactlinetwo{+254 741997729}
...
\begin{invoice}
	\begin{invoicetable}
		\invoiceitem{System Development}{1}{5600}
		\invoiceitem{System Integration}{25}{25.95}
		\invoiceitem{System Deployment}{7}{49.99}
	\end{invoicetable}
\end{invoice}
